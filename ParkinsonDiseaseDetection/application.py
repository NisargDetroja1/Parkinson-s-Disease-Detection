...
def extract_features(audio_path):
    ...
    MDVP_Fo_Hz = praat.call(pitch, "Get mean", 0, 0, "Hertz")
    MDVP_Fhi_Hz = praat.call(pitch, "Get maximum", 0, 0, "Hertz", "Parabolic")
    MDVP_Flo_Hz = praat.call(pitch, "Get minimum", 0, 0, "Hertz", "Parabolic")
